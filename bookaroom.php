				...
				<div class="row">
					...
					<div class="mt-0">
						...
						<nav class="navbar navbar-expand-lg navbar-light bg-providno d-flex p-1 mb-1" id="navOnScroll">
							...
							<form class="list-unstyled mr-auto collapse navbar-collapse" id="navbarBooking"  method="GET" onsubmit="return formValidate()" action="checknow.php">
...
<script src='js/bookaroom.js'></script>